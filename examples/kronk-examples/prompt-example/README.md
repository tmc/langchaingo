# Kronk Prompt Example

A minimal single prompt example using the kronk abstraction layer to run a local GGUF model via llama.cpp.
...
```shell
go run prompt_example.go -model unsloth/Qwen3-0.6B-Q8_0 -prompt "What is 2+2?"
```
