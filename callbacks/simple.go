...
func (SimpleHandler) HandleLLMGenerateContentStart(context.Context, []schema.MessageContent) {}
func (SimpleHandler) HandleLLMGenerateContentEnd(context.Context, *schema.ContentResponse)   {}
