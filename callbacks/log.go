...
func (l LogHandler) HandleLLM(ctx context.Context, _ []llms.MessageContent, info llms.CallOptions, next func(ctx context.Context) (*llms.ContentResponse, error)) (*llms.ContentResponse, error) {
...
func (l LogHandler) HandleChain(ctx context.Context, inputs map[string]any, _ schema.ChainInfo, next func(ctx context.Context) (map[string]any, error)) (map[string]any, error) {
