...
func getValues(t *testing.T) (string, string) {
	...
	tencentvectordbHost := os.Getenv("TENCENTVECTORDB_HOST")
	if tencentvectordbHost == "" {
		t.Skip("Must set TENCENTVECTORDB_HOST to run test")
	}
	...
	return tencentvectordbAPIKey, tencentvectordbHost
}

func TestTencentvectordbStoreRest(t *testing.T) {
	t.Parallel()
	...
	storer, err := tencentvectordb.New(
		...
		tencentvectordb.WithHost(host),
		tencentvectordb.WithEmbedder(e),
		tencentvectordb.WithNameSpace(uuid.New().String()),
	)
	require.NoError(t, err)
...
func TestTencentvectordbStoreRestWithScoreThreshold(t *testing.T) {
	t.Parallel()
...
func TestTencentvectordbAsRetriever(t *testing.T) {
	t.Parallel()
...
func TestTencentvectordbAsRetrieverWithScoreThreshold(t *testing.T) {
	t.Parallel()
...
func TestTencentvectordbAsRetrieverWithMetadataFilterEqualsClause(t *testing.T) {
	t.Parallel()
...
func TestTencentvectordbAsRetrieverWithMetadataFilterInClause(t *testing.T) {
	t.Parallel()
...
func TestTencentvectordbAsRetrieverWithMetadataFilterNotSelected(t *testing.T) {
	t.Parallel()
...
func TestTencentvectordbAsRetrieverWithMetadataFilters(t *testing.T) {
	t.Parallel()
