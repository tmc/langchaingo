...
func TestChromaGoStoreV2Rest(t *testing.T) {
	t.Parallel()
	...
	s, err := chroma.NewV2(
		...
		chroma.WithDistanceFunctionV2(chromatypes.COSINE),
...
func TestChromaStoreRestWithScoreThresholdV2(t *testing.T) {
	t.Parallel()

	testChromaURL, openaiAPIKey := getValuesV2(t)
	llm, err := openai.New()
	require.NoError(t, err)
	e, err := embeddings.NewEmbedder(llm)
	require.NoError(t, err)
...
func TestSimilaritySearchWithInvalidScoreThresholdV2(t *testing.T) {
	t.Parallel()
...
func TestChromaAsRetrieverV2(t *testing.T) {
	t.Parallel()
...
func TestChromaAsRetrieverWithScoreThresholdV2(t *testing.T) {
	t.Parallel()
...
func TestChromaAsRetrieverWithMetadataFilterEqualsClauseV2(t *testing.T) {
	t.Parallel()
...
func TestChromaAsRetrieverWithMetadataFilterInClauseV2(t *testing.T) {
	t.Parallel()
...
func TestChromaAsRetrieverWithMetadataFilterNotSelectedV2(t *testing.T) {
	t.Parallel()
...
func TestChromaAsRetrieverWithMetadataFiltersV2(t *testing.T) {
	t.Parallel()
...
func getValuesV2(t *testing.T) (string, string) {
	t.Helper()
...
func cleanupTestArtifactsV2(t *testing.T, s chroma.StoreV2) {
	t.Helper()
