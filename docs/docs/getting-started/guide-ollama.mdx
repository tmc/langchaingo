...
Here is the entire program (from [ollama-completion-example](https://github.com/vxcontrol/langchaingo/blob/main-vxcontrol/examples/ollama-completion-example/ollama_completion_example.go)):
