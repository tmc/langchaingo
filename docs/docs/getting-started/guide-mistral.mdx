...
```shell
go run github.com/vendasta/langchaingo/examples/mistral-completion-example@main
```
...
Here is the entire program (from [mistral-completion-example](https://github.com/vendasta/langchaingo/blob/main/examples/mistral-completion-example/mistral_completion_example.go)):
