...
Here is the entire program (from [mistral-completion-example](https://github.com/vxcontrol/langchaingo/blob/main-vxcontrol/examples/mistral-completion-example/mistral_completion_example.go)):
