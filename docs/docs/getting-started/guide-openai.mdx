...
Here is the entire program (from [openai-completion-example](https://github.com/vxcontrol/langchaingo/blob/main-vxcontrol/examples/openai-completion-example/openai_completion_example.go)):
