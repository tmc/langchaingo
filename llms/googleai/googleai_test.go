...
func newHTTPRRClient(t *testing.T, recordingName string, opts ...Option) *GoogleAI {
	t.Helper()
	...
	// Only use test API key when NOT recording
	if !rr.Recording() {
...
func TestGoogleAIGenerateContent(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIGenerateContent.httprr")
...
func TestGoogleAIGenerateContentWithMultipleMessages(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIGenerateContentWithMultipleMessages.httprr")
...
func TestGoogleAIGenerateContentWithSystemMessage(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIGenerateContentWithSystemMessage.httprr")
...
func TestGoogleAICall(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAICall.httprr")
...
func TestGoogleAICreateEmbedding(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAICreateEmbedding.httprr")
...
func TestGoogleAIWithOptions(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIWithOptions.httprr",
...
func TestGoogleAIWithStreaming(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIWithStreaming.httprr")
...
func TestGoogleAIWithTools(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIWithTools.httprr")
...
func TestGoogleAIWithJSONMode(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIWithJSONMode.httprr")
...
func TestGoogleAIMultiModalContent(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIMultiModalContent.httprr")
...
func TestGoogleAIBatchEmbedding(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIBatchEmbedding.httprr")
...
func TestGoogleAIWithHarmThreshold(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIWithHarmThreshold.httprr",
...
func TestGoogleAIToolCallResponse(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestGoogleAIToolCallResponse.httprr")
