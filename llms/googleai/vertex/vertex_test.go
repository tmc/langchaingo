...
func newHTTPRRClient(t *testing.T, recordingName string, opts ...googleai.Option) *Vertex {
	t.Helper()
	...
	if location := os.Getenv("VERTEX_LOCATION"); location == "" {
		opts = append(opts, googleai.WithCloudLocation("us-central1"))
	} else {
...
func TestVertexGenerateContent(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexGenerateContent.httprr")
...
func TestVertexGenerateContentWithMultipleMessages(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexGenerateContentWithMultipleMessages.httprr")
...
func TestVertexGenerateContentWithSystemMessage(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexGenerateContentWithSystemMessage.httprr")
...
func TestVertexCall(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexCall.httprr")
...
func TestVertexCreateEmbedding(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexCreateEmbedding.httprr")
...
func TestVertexWithOptions(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexWithOptions.httprr",
...
func TestVertexWithStreaming(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexWithStreaming.httprr")
...
func TestVertexWithTools(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexWithTools.httprr")
...
func TestVertexWithJSONMode(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexWithJSONMode.httprr")
...
func TestVertexMultiModalContent(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexMultiModalContent.httprr")
...
func TestVertexBatchEmbedding(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexBatchEmbedding.httprr")
...
func TestVertexWithHarmThreshold(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexWithHarmThreshold.httprr",
...
func TestVertexToolCallResponse(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexToolCallResponse.httprr")
...
func TestVertexWithResponseMIMEType(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexWithResponseMIMEType.httprr")
...
func TestVertexErrorOnConflictingOptions(t *testing.T) {
	...
	llm := newHTTPRRClient(t, "TestVertexErrorOnConflictingOptions.httprr")
