...
type ChatMessage = perplexityclient.ChatMessage

type LLM struct {
	CallbacksHandler callbacks.Handler
	client           *perplexityclient.Client
}
...
// New returns a new perplexity LLM.
...
func (o *LLM) GenerateContent(ctx context.Context, messages []llms.MessageContent, options ...llms.CallOption) (*llms.ContentResponse, error) { //nolint: lll, cyclop
	...
	req := &perplexityclient.ChatRequest{
		Model:            opts.Model,
	...
	for _, fn := range opts.Functions {
		req.Functions = append(req.Functions, perplexityclient.FunctionDefinition{
			Name:        fn.Name,
