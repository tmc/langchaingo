...
// 12. Structured Output: llms/structuredoutput/
//
...
//
// The `options.go` file provides various per-call options to configure the LLMs, including reasoning
// controls (WithReasoning, WithAdaptiveReasoning, WithReasoningDisabled) and provider-neutral
// schema-constrained output (WithStructuredOutput). The reasoning package resolves model capabilities
// for the former; the structuredoutput package validates responses for the latter.
package llms
