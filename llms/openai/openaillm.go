...
func (o *LLM) GenerateContent(ctx context.Context, messages []llms.MessageContent, options ...llms.CallOption) (*llms.ContentResponse, error) { //nolint: lll, cyclop, goerr113, funlen, gocognit
	if o.CallbacksHandler != nil {
		o.CallbacksHandler.HandleLLMGenerateContentStart(ctx, messages)
	}

	opts := o.applyOptions(options)

	return o.CallbacksHandler.HandleLLM(ctx, messages, opts, func(ctx context.Context) (*llms.ContentResponse, error) {
		...
		response := &llms.ContentResponse{Choices: choices, Usage: &llms.Usage{
			TotalTokens:      result.Usage.TotalTokens,
			PromptTokens:     result.Usage.PromptTokens,
			CompletionTokens: result.Usage.CompletionTokens,
		}}
...
func (o *LLM) applyOptions(options []llms.CallOption) llms.CallOptions {
	...
	if o.client.Model == "" {
		opts.Model = o.client.EmbeddingModel
	}
